...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<%@ include file="/common/manager/style.jsp"%> 
					...
					<div class="portlet solid bordered grey-cararra">
						...
						<div class="portlet-body">
							<div id="site_statistics_loading">
								<img src="assets/admin/layout/img/loading.gif"
									alt="loading" />
							</div>
						...
						<div class="portlet-body">
							...
							<div class="tabbable tabbable-custom">
								<ul class="nav nav-tabs">
									...
									<li><a href="#tab_1_3" data-toggle="tab"> Recent Users
									</a></li>
								</ul>
									...
									<li class="out"><img class="avatar" alt=""
										...
										<div class="message">
											<span class="arrow"> </span> <a href="#" class="name">
												...
												class="body"> Lorem ipsum dolor sit amet,
												consectetuer adipiscing elit, sed diam nonummy nibh euismod
												tincidunt ut laoreet dolore magna aliquam erat volutpat. sed
												diam nonummy nibh euismod tincidunt ut laoreet. </span>
										</div></li>
								</ul>
							</div>
							<div class="chat-form">

		...
		<div class="page-sidebar navbar-collapse collapse">
			...
			<ul class="page-sidebar-menu page-sidebar-menu-closed"
				...
				<li class="active open"><a href="javascript:;"> <i
						class="icon-docs"></i> <span class="title">Pages</span> <span
					...
					<ul class="sub-menu">
						...
						<li class="active"><a href="extra_profile.html"> <i
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-footer">
							<button name="button" value= "modal" type="button" class="btn blue">Save changes</button>
					...
					<div class="profile-sidebar">
						...
						<div class="portlet light profile-sidebar-portlet">
							...
							<div class="profile-userpic">
								<img
									src="data:image/png;base64,${imgencode}"
							...
							<div class="profile-usermenu">
								<ul class="nav">
									<li><a href="extra_profile.html"> <i class="icon-home"></i>
											Overview
									</a></li>
									<li class="active"><a href="extra_profile_account.html">
											<i class="icon-settings"></i> Account Settings
									</a></li>
									<li><a href="page_todo.html" target="_blank"> <i
											class="icon-check"></i> Tasks
									</a></li>
									<li><a href="extra_profile_help.html"> <i
									...
									<div class="portlet-body">
										<div class="tab-content">
											...
											<div class="tab-pane active" id="tab_1_1">
												<form role="form" action="profile_account" method="post">
													<div class="form-group">
														<label class="control-label">Full Name</label> <input
															name = "fullnameinput"
															type="text" placeholder="Your full name" class="form-control"
															value = "${fullname}" />
													</div>
													...
													<div><span style="color:${color1}">${msg1}</span> </div>
														<button name="button" value = "update1" class="btn green-haze"> Save Changes </button>
													
														 <a href="${back}" class="btn default"> Cancel </a>
													</div>
												</form>
											</div>
											...
											<div class="tab-pane" id="tab_1_2">
												...
												<form action="profile_account" role="form" method="post" enctype="multipart/form-data">
													<div class="form-group">
													...
													<div class="margin-top-10">
														<button name="button" id ="update2" value = "update2" class="btn green-haze"> Submit </button> 
											...
											<div class="tab-pane" id="tab_1_3">
												<form action="profile_account" role="form" method="post">
													<div class="form-group">
													...
													<div class="margin-top-10">
														<button name="button" value ="update3" class="btn green-haze"> Change Password </button>
														 <a href="#" class="btn default"> Cancel </a>
													</div>
												</form>
											</div>
												...
												<form action="#">
													...
													<span style="color:green">${msg2}</span>
														<a href="#" class="btn green-haze"> Save Changes </a> <a
															href="${back}" class="btn default"> Cancel </a>
													</div>
												</form>
											</div>
